...
class QueryDeluxe(models.Model):
    ...
    tips_description = fields.Text(related='tips.description', readonly=True)
    ...
    def execute(self):
        ...
        if self.name:
            ...
            if headers and datas:
                ...
                header_html += "".join(["<th style='border: 1px solid black; text-align: center'>" + str(header) + "</th>" for header in headers])
                header_html += "</tr>"
